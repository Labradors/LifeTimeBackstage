...
public class User {
	...
	public int getUser_authorId() {
		return user_authorId;
	}
	public void setUser_authorId(int user_authorId) {
		this.user_authorId = user_authorId;
	}
	...
	public String toString() {
		return "User [user_id=" + user_id + ", user_email=" + user_email
				+ ", user_authorId=" + user_authorId + ", user_name="
				+ user_name + ", user_headpicture=" + user_headpicture
				+ ", user_jointime=" + user_jointime + ", user_sex=" + user_sex
